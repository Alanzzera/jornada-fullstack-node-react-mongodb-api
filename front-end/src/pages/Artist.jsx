...
const Artist = () => {
  const { id } = useParams();
  //const artistObg = artistsArray.filter((currentArtistObj) => currentArtistObj._id === Number(id))[0];
  const { name, banner} = artistsArray.filter((currentArtistObj) => currentArtistObj._id === id)[0];
